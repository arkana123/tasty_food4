...
import 'package:tasty_food/admin/kurir/kurir.dart';
import 'package:tasty_food/admin/laporan/laporan.dart';
import 'package:tasty_food/admin/restaurant/restaurant.dart';
import 'package:tasty_food/admin/transaksi/transaksi2.dart';
import 'package:tasty_food/admin/user/user.dart';
              ...
              child: GridView.count(
                ...
                children: [
                  InkWell(
                    ...
                    child: itemDashboard("User", CupertinoIcons.person_2, Colors.green),
                  ),
                  InkWell(
                    onTap: () {
                      Navigator.push(
                  ...
                  InkWell(
                    ...
                    child: itemDashboard("Restaurant", CupertinoIcons.cart, Colors.deepOrange),
                  ),
                  InkWell(
                    onTap: () {
                      Navigator.push(
